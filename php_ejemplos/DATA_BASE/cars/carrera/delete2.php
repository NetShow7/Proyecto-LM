                ...
                <div class="content">
                    ...
                    <table class="tbl" border=1 >
                      ...
                      while ($x = mysqli_fetch_array($result)) {
                        printf("<tr><td>%s</td><td>%s</td><td>%s</td><td>%d</td><td>%s</td><td><a href=\"delete2.php?Chassis_number=%s\">Delete</a> </td></tr>", $x["Chassis_number"], $x["brand"], $x["model"], $x["year"], $x["color"]);
                      }
