  ...
  <div id="wrap">
    <div id="content-container">
      <div id="header">
        ...
        <h1><a href="http://www.free-css.com/">Carrera</a></h1>
        <div id="subtitle">Free CSS Template</div>
        <div class="alignleft"> </div>
        <div id="menu_search_box">
          <form method="get" id="searchform" style="display:inline;" href="http://www.free-css.com/">
        ...
        <div  id="content">
          <div class="post-container">
            <div class="post" id="post-3">
              <div class="posttop">
                <h2><a href="http://www.free-css.com/">Delete car </a></h2>
                <div class="postinfo">
                ...
                <div class="content">
                    ...
                    <table class="tbl" border=1 >
                      ...
                      while ($x = mysqli_fetch_array($result)) {
                        printf("<tr><td>%s</td><td>%s</td><td>%s</td><td>%d</td><td>%s</td><td><a href=\"delete_car.php?chassis=%s\">Delete</a> </td></tr>", $x["Chassis_number"], $x["brand"], $x["model"], $x["year"], $x["color"],$x["Chassis_number"]);
                      }
                ...
                <ul>
                  <li id="categories-187785351" class="widget widget_categories">
                    ...
                    <ul>
                      ...
                      <li><a href="http://www.free-css.com/">Wallpapers</a> </li>
                    </ul>
                  </li>
              ...
              <div id="sidebar2">
                <ul>
                  ...
                  <li>
                    <h2>Categories</h2>
                    <ul>
                      <li><a href="http://www.free-css.com/">Templates</a> (1) </li>
                      <li><a href="http://www.free-css.com/">Wallpapers</a> (1) </li>
                    </ul>
                  </li>
                  <li class="linkcat">
                    <h2>Blogroll</h2>
