      ...
      <div id="navlist-container">
        <div id="navlist">
          <ul>
            ...
            <li class="current_page_item"><a href="select.php">Select</a></li>
    ...
    <div  id="content">
      <div class="post-container">
        <div class="post" id="post-3">
          <div class="posttop">
            <h2><a href="http://www.free-css.com/"> Select </a></h2>
            <div class="postinfo">
          ...
          <div class="entry">
            <div class="content">
              <form action="search_car.php" method="post">
                  <table class="tbl">
                    Type the chassis number you want to search for:
                    <tr><td>
                      Chassis number:<br>
                      </td>

                      <td>
                        <td><input type="text" name="chassis" value="Find"><br>
                        </tr>
                      </td>
                    </tr>
                  </table>
